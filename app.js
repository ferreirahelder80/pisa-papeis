...
const CATEGORIES = [
    ...
    subfolders: [
      {
        ...
        monthlyDocs: { 0: 0, 1: 0, 2: 10, 3: 11, 4: 1, 5: 0, 6: 0, 7: 0, 8: 0, 9: 0, 10: 0, 11: 0 },
        ...
        knownFiles: {
          2: [ // Março
            ...
            { name: 'Pagamento Antecipado Ticket Educação 2026.pdf', label: 'Ticket Educação — Pagamento Antecipado ZC (Abr 2026)', type: 'pdf', date: '2026-04', amount: 4942.80, link: 'https://drive.google.com/file/d/1WuQZ_1AJIh3ubvcus1oSxydWmbrBLKTm/view' }
          ],
          4: [ // Maio
          ...
          3: [ // Abril
            ...
            { name: 'GasSU Abril 2026.PDF', label: 'GasSU — Gás Zebra Curiosa (Abr 2026)', type: 'pdf', date: '2026-04', amount: 5.50, link: 'https://drive.google.com/file/d/1Jda-4lGmaTVma_uy9F60TxkqjV6wGUvc/view' },
            { name: 'Via Verde Abril 2026.pdf', label: 'Via Verde — Fatura Zebra Curiosa (Abr 2026)', type: 'pdf', date: '2026-04', amount: 36.70, link: 'https://drive.google.com/file/d/1aKy7-eSXAXwRFl9r1OdQUxs-7NHLEp3R/view' },
            { name: 'Vodafone Abril 2026.pdf', label: 'Vodafone — Fatura Zebra Curiosa (Abr 2026)', type: 'pdf', date: '2026-04', amount: 221.26, link: 'https://drive.google.com/file/d/1kvP39sOMyJdHv4mH1srUeyxUxkWISrjp/view' },
            { name: 'Condomínio Abril 2026.pdf', label: 'Condomínio Solar — Carta de Cobrança 2 (Abr 2026)', type: 'pdf', date: '2026-04', link: 'https://drive.google.com/file/d/1JN5vcNhyUce5QjJGKNqUB64_2NQdIcg8/view' }
          ],
          1: [ // Fevereiro
      ...
      },
      {
        ...
        monthlyDocs: { 0: 0, 1: 0, 2: 8, 3: 2, 4: 0, 5: 0, 6: 0, 7: 0, 8: 0, 9: 0, 10: 0, 11: 0 },
        hasMonthFolders: true,
        knownFiles: {
          2: [
          ...
          3: [
            ...
            { name: 'Subscrição Perplexity Abril 2026.pdf', label: 'Perplexity — Subscrição Mensal Zebra Curiosa (Abr 2026)', type: 'pdf', date: '2026-04', amount: 345.00, link: 'https://drive.google.com/file/d/1v2ra7s1i6lG2XmMfFAFk5Pp98sz-rFOj/view' }
          ]
        }
      }
    ]
  },
  {
    ...
    knownFiles: {
      ...
      2: [ // Março
        ...
        { name: 'Roblox Março 2026.pdf', label: 'Roblox — Subscrição (Mar 2026)', type: 'pdf', date: '2026-03', link: 'https://drive.google.com/file/d/1BQh023DYqabb419uU9CITvOziispZ8rZ/view' },
        { name: 'Roblox Slap Battles Março 2026.pdf', label: 'Roblox Slap Battles — Subscrição (Mar 2026)', type: 'pdf', date: '2026-03', link: 'https://drive.google.com/file/d/1gs2N67GHNGzCVoJYKGt4unWLPLuc6zDj/view' },
        ...
        { name: 'YouTube Premium Pagamento Pessoal Março 2026.pdf', label: 'YouTube Premium — Subscrição Mensal (Mar 2026)', type: 'pdf', date: '2026-03-10', link: 'https://drive.google.com/file/d/1OrxgxjPfCcTnUfs9_pMfcBiz_bmYfQIO/view' },
  ...
  },
  {
    ...
    monthlyDocs: { 0: 0, 1: 0, 2: 5, 3: 3, 4: 0, 5: 0, 6: 0, 7: 0, 8: 0, 9: 0, 10: 0, 11: 0 },
    knownFiles: {
      0: [], // Janeiro
      1: [], // Fevereiro
      2: [ // Março
      ...
      3: [ // Abril
        ...
        { name: 'Farmácia Abril 2026, 46,19€.pdf', label: 'Farmácia — Recibo €46,19 (Abr 2026)', type: 'pdf', date: '2026-04', amount: 46.19, link: 'https://drive.google.com/file/d/1gw4QSbqm0lO4mAJoZOq1qyo6i6Bo_kCD/view' },
        { name: 'Curso Happy Code.pdf', label: 'Happy Code — Curso Simão (Abr 2026)', type: 'pdf', date: '2026-04-07', amount: 130.00, link: 'https://drive.google.com/file/d/1JrTQrvofY-Mzf39hwGRgCtcODt6IftoY/view' }
      ]
    }
  },
  {
    ...
    subfolders: [
      {
        ...
        monthlyDocs: { 0: 0, 1: 0, 2: 4, 3: 2, 4: 0, 5: 0, 6: 1, 7: 2, 8: 0, 9: 2, 10: 5, 11: 2 },
        hasMonthFolders: true,
        knownFiles: {
          0: [], // Janeiro
          2: [ // Março
            { name: 'escala março 2026.docx', label: 'Escala HLPV — Março 2026', type: 'docx', date: '2026-03', link: gdLink(GD_PATHS.escalasHLPV, 3) },
            { name: 'escala partos março 2026.docx', label: 'Escala Partos HLPV — Março 2026', type: 'docx', date: '2026-03', link: 'https://docs.google.com/document/d/160AZ16YnojAFXgz4x6EjINqmYjhgHWGI/edit' }
          ],
          3: [ // Abril
            { name: 'Escala HLPV Abril 2026.docx', label: 'Escala HLPV — Abril 2026', type: 'docx', date: '2026-04', link: 'https://drive.google.com/file/d/10PkiICn_Bt0OblNZd_oFNiuuWSShZIIq/view' },
            { name: 'Escala HLPV Partos Abril 2026.docx', label: 'Escala Partos HLPV — Abril 2026', type: 'docx', date: '2026-04', link: 'https://drive.google.com/file/d/1B6PIeehsQutGQdNyqu0O3ca3FlFRs8XO/view' }
          ],
          6: [ // Julho
      ...
      },
      {
        ...
        monthlyDocs: { 0: 0, 1: 0, 2: 2, 3: 6, 4: 0, 5: 0, 6: 0, 7: 0, 8: 0, 9: 0, 10: 0, 11: 0 },
        hasMonthFolders: true,
        knownFiles: {
          2: [ // Março
          ...
          3: [ // Abril
            ...
            { name: 'Psicologia Março Abril 2026.pdf', label: 'Rute Ferreira — Recibo Vencimento Psicologia CPC (Abr 2026)', type: 'pdf', date: '2026-04', amount: 3997.77, link: 'https://drive.google.com/file/d/1pwOMQnstOhe67ZrIuxpwNJvJ6LisnKxc/view' },
            ...
            { name: 'Recibo Março Abril 26 - TF Cristiana Barbosa.pdf', label: 'Cristiana Barbosa — Recibo Vencimento TF CPC (Abr 2026)', type: 'pdf', date: '2026-04', link: 'https://drive.google.com/file/d/1gTJ35a2vFxUW6k5M1u8V-BZ6yZnepjt6/view' },
            { name: '514199920 Salarios Março Abril.PDF', label: 'CPC — Salários Março/Abril 2026 (Abr 2026)', type: 'pdf', date: '2026-04', link: 'https://drive.google.com/file/d/1TmVLg-hIHoeU0L_E33_BEKNUYCiO22lL/view' },
            { name: 'Psicologia Março Abril 2026 (2).pdf', label: 'Rute Ferreira — Recibo Vencimento Psicologia CPC Alt. (Abr 2026)', type: 'pdf', date: '2026-04', link: 'https://drive.google.com/file/d/1TtpHjxPtP56t-AtB-QZjw7KdLkxZXfVN/view' }
          ]
        }
      },
      {
        ...
        monthlyDocs: { 0: 0, 1: 1, 2: 2, 3: 0, 4: 0, 5: 0, 6: 0, 7: 0, 8: 0, 9: 0, 10: 0, 11: 0 },
        hasMonthFolders: true,
        knownFiles: {
          1: [ // Fevereiro
          ...
          2: [ // Março
            { name: 'Vencimento Detalhado HLPV Março 2026.pdf', label: 'Vencimento Detalhado HLPV — Março 2026', type: 'pdf', date: '2026-03', link: 'https://drive.google.com/file/d/1mWKwBFnRbjiCm5C3j2S1UVtYq8MnqYuf/view' },
            { name: 'Vencimento Resumido HLPV Março 2026.pdf', label: 'Vencimento Resumido HLPV — Março 2026', type: 'pdf', date: '2026-03', link: 'https://drive.google.com/file/d/1IkdbDwEF9NNYgs-qqapZuZG-7s8QVMO3/view' }
          ]
        }
      }
    ]
